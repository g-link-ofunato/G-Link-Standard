...
console.info('[G-Link Notify]',{time:new Date().toISOString(),build:'Build1331',event:'S026360-SCRIPT-LOADED'});
const BUILD='Build1331',PORTAL_BASE='https://g-link-portal.pages.dev',LOCAL_KEY='gLink_standardAuthRemembered',SESSION_KEY='gLink_standardAuthSession';
