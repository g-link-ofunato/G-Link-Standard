...
console.info('[G-Link Notify]',{time:new Date().toISOString(),build:'Build0835',event:'S026360-SCRIPT-LOADED'});
const BUILD='Build0835',PORTAL_BASE='https://g-link-portal.pages.dev',LOCAL_KEY='gLink_standardAuthRemembered',SESSION_KEY='gLink_standardAuthSession';
