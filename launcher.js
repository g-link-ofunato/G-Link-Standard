...
/* Build026.3.4: reliable important-notification queue and re-display control */
(()=>{
'use strict';
if(window.__GLINK_STANDARD_NOTIFICATIONS_LOADED__) return;
window.__GLINK_STANDARD_NOTIFICATIONS_LOADED__=true;
console.info('[G-Link Notify]',{time:new Date().toISOString(),build:'Build026.3.4',event:'S026340-SCRIPT-LOADED'});
const BUILD='Build026.3.4',PORTAL_BASE='https://g-link-portal.pages.dev',LOCAL_KEY='gLink_standardAuthRemembered',SESSION_KEY='gLink_standardAuthSession';
